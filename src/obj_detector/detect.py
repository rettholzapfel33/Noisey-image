...
from src.obj_detector.utils.datasets import ImageFolder
from src.obj_detector.utils.transforms import Resize, DEFAULT_TRANSFORMS
...
#def _draw_and_display_output_image(image, detections, img_size, classes):
