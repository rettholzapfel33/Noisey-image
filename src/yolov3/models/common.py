...
from src.yolov3.utils.datasets import exif_transpose, letterbox
from src.yolov3.utils.general import (LOGGER, check_requirements, check_suffix, colorstr, increment_path, make_divisible,
                           non_max_suppression, scale_coords, xywh2xyxy, xyxy2xywh)
from src.yolov3.utils.plots import Annotator, colors, save_one_box
from src.yolov3.utils.torch_utils import time_sync
...
class DetectMultiBackend(nn.Module):
    ...
    def __init__(self, weights='yolov3.pt', device=None, dnn=True):
        ...
        if jit:  # TorchScript
            ...
            from src.yolov3.models.experimental import attempt_load  # scoped to avoid circular import
