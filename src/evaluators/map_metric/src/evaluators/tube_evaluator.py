...
import numpy as np
from src.evaluators.map_metric.src.evaluators.pascal_voc_evaluator import (calculate_ap_11_point_interp,
                                                 calculate_ap_every_point)
from src.evaluators.map_metric.src.tube import Tube
from src.evaluators.map_metric.src.utils.enumerators import MethodAveragePrecision
from src.evaluators.map_metric.src.utils.read_files import File
