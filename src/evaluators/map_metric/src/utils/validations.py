...
import pandas as pd
from src.evaluators.map_metric.src.utils.enumerators import CoordinatesType
from src.evaluators.map_metric.src.utils.general_utils import get_files_recursively
